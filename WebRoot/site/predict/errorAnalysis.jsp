						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<a><i class="fa fa-star-half-full"></i>&nbsp;误差分析</a>
								</div>
								<!-- /.panel-heading -->
								<div class="panel-body">
									<table>
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td valign="bottom">
												<button id="view_err"class="btn btn-primary btn-outline">查看误差</button>
											</td>
										</tr>
									</table>
							...
							<!-- /.col-lg-12 -->
							<div class="row" id="err_ana_result" style="display:none">
								<div class="col-lg-12">
									<div class="panel panel-default">
										<div class="panel-heading">
											<a><i class="fa fa-star"></i>&nbsp;误差走势</a>
										</div>
										<div class="panel-body" style="height:450px;">
											<div class='dataTable_wrapper'>
												<div id="test" style="margin-top: 5px;"></div>
							...
							<div class="row" id="err_sum_result" style="">
								<div class="col-lg-12">
									<div class="panel panel-default">
										<div class="panel-heading">
											<a><i class="fa fa-bar-chart-o"></i>&nbsp;误差统计</a>
										</div>
										<div class="panel-body"
											style="height:auto;font-family:'微软雅黑'">
											<div class='dataTable_wrapper'>
												<div id="err_sum_bar" style="width:50%;float:left"></div>
												<div id="err_sum_pie" style="width:50%;float:left"></div>
												<div style="clear:both;clear:both;border-bottom:1.5px dashed #6FB1D8;"></div>
												<div style="" id="err_cdf"></div>
											</div>
										</div>
									</div>
								</div>
