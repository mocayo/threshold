...
<body>
    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <div class="row" id="query_point_result" style="display:none">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><a><i class="fa fa-tags"></i>&nbsp;预处理结果</a></div>
    ...
    <script type="text/javascript" src="js/query_point.js"></script>
