...
<body>
						...
						<div class="col-lg-9">
							<div class="panel panel-default">
								<div class="panel-heading">
									<a><i class="fa fa-pencil"></i>&nbsp;添加测点(预处理)</a>
								</div>
								<div class="panel-body">
									<form action="addptmmodelpoint" method="post">
												...
												<tr>
													<td><label>监测仪器</label>
														<div class="form-group dk-select"
															...
															<select id="decType_Sel" class="form-control"
																name="modelpointrecord.MonitorItem">
													...
													<td><label>测点编号</label>
														<div class="form-group dk-select"
															style="width: 148px;margin-bottom:0px;">
															<select id="instr_Sel" class="form-control"
																multiple="multiple" size="1"
																name="modelpointrecord.Instr_no">
																multiple="multiple" size="1"
																<!-- 					<option value='C4-A22-PL-04' selected>C4-A22-PL-04</option> -->
																<option value='' selected>---请选择---</option>
															</select>
														</div></td>
													<td>&nbsp;&nbsp;</td>
													<td><label>预测分量</label>
														<div class="form-group dk-select"
															...
															<select id="component_Sel" class="form-control"
																multiple="multiple" size="1" name="modelpointrecord.R">
																<option value='' selected>---请选择---</option>
 ...
 --%>									
										...
										<tr>
											...
											<td><label>测点</label>
												<div>
													<select class="form-control" id="point_sel" name="modelpointrecord.Instr_no">
														<option value='' selected>---请选择---</option>
													</select>
												</div></td>
											<td>&nbsp;&nbsp;</td>
											<td><label>分量</label>
												<div>
													<select class="form-control" id="comp_sel" name="modelpointrecord.R">
														<option value='' selected>---请选择---</option>
													</select>
												</div></td>
										</tr>
						...
						<div class="col-lg-3">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<%@include file="../incoming/ptmupload.jsp"%>
								</div>
							</div>
						</div>
					</div>
