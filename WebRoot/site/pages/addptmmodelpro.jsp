       ...
       <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">添加预处理模型pro</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
				...
				<div class="panel-body">
                 <div class="row">
                 <div class="col-lg-6">
				 <form id="addform" role="form" action="addptmmodel" method="post" onsubmit="return checkForm()">
					...
					<div class="form-group">
						...
						<input type="hidden" name="model.modeltype" value="0">
